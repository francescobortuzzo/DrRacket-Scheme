...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 20211026lab2) (read-case-sensitive #t) (teachpacks ((lib "drawing.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "drawing.ss" "installed-teachpacks")) #f)))
;; Square-Cross Puzzle
...
(define croce
  (glue-tiles
     ...
     (glue-tiles
        larger-tile
        (shift-right(shift-down (half-turn larger-tile) 1)2)
     )
  )
 )
...
(define quadrato
   (glue-tiles
   (glue-tiles
      (shift-right(quarter-turn-left larger-tile)2)
      (shift-right(half-turn larger-tile)1))
   (glue-tiles
      (shift-down(shift-right(quarter-turn-right(half-turn smaller-tile))6)2)
      (shift-down(shift-right(quarter-turn-right larger-tile)1)2))
    )
  )